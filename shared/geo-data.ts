...
export const INTEL_HOTSPOTS: Hotspot[] = [
  ...
  // South China Sea / West Philippine Sea flashpoints. China Coast Guard and
  // maritime-militia hulls routinely run dark on AIS, so these are plotted at
  // the contested features themselves and light up from reporting that names
  // them (AMTI, Naval News, USNI, GMA, ABS-CBN, South China Sea Watch feeds).
  // Keywords avoid 'pagasa' (the Philippine weather bureau) and a bare
  // 'sierra madre' (a mountain range) to keep weather news off the map.
  {
    id: 'west_philippine_sea',
    name: 'West Philippine Sea',
    subtext: 'CCG/Militia Watch',
    lat: 13.0,
    lon: 116.5,
    location: 'South China Sea',
    keywords: ['west philippine sea', 'south china sea', 'china coast guard', 'maritime militia', 'philippine coast guard'],
    agencies: ['China Coast Guard', 'PLA Navy', 'PAFMM', 'Philippine Coast Guard', 'Armed Forces of the Philippines'],
    description: 'Grey-zone pressure on Philippine-claimed waters. Water cannon, blocking and ramming incidents.',
    status: 'Monitoring',
    escalationScore: 4,
    escalationTrend: 'escalating',
    escalationIndicators: ['Water cannon and ramming incidents', 'Maritime militia swarms', 'Resupply blockades', 'US-Philippines joint patrols'],
    history: {
      lastMajorEvent: 'Arbitral tribunal rejects nine-dash line',
      lastMajorEventDate: '2016-07-12',
      precedentCount: 3,
      precedentDescription: 'Scarborough standoff 2012, Reed Bank sinking 2019, Second Thomas boarding 2024',
      cyclicalRisk: 'Arbitral award anniversary (July 12), Balikatan exercises, resupply missions',
    },
    whyItMatters: 'US-Philippines Mutual Defense Treaty trigger risk; about a third of global maritime trade transits the sea',
  },
  {
    id: 'scarborough_shoal',
    name: 'Scarborough Shoal',
    subtext: 'Bajo de Masinloc',
    lat: 15.18,
    lon: 117.76,
    location: 'South China Sea',
    keywords: ['scarborough', 'bajo de masinloc', 'panatag', 'huangyan'],
    agencies: ['China Coast Guard', 'Philippine Coast Guard', 'BFAR'],
    description: 'China-held shoal inside the Philippine EEZ. Fishing access and CCG blockades.',
    status: 'Monitoring',
    escalationScore: 4,
    escalationTrend: 'escalating',
    escalationIndicators: ['CCG water cannon on Filipino vessels', 'Floating barriers at the lagoon mouth', 'Fishing access denial'],
    history: {
      lastMajorEvent: 'Scarborough standoff; China takes control',
      lastMajorEventDate: '2012-04-10',
      precedentCount: 1,
      precedentDescription: 'Standoff 2012, arbitral award 2016',
      cyclicalRisk: 'Fishing season, arbitral award anniversary',
    },
    whyItMatters: 'Closest contested feature to Luzon and Subic Bay',
  },
  {
    id: 'second_thomas_shoal',
    name: 'Second Thomas Shoal',
    subtext: 'Ayungin / BRP Sierra Madre',
    lat: 9.74,
    lon: 115.87,
    location: 'Spratly Islands',
    keywords: ['second thomas', 'ayungin', 'brp sierra madre'],
    agencies: ['China Coast Guard', 'Philippine Navy', 'Philippine Marines'],
    description: 'Philippine outpost on the grounded BRP Sierra Madre. CCG blocks resupply missions.',
    status: 'Monitoring',
    escalationScore: 4,
    escalationTrend: 'stable',
    escalationIndicators: ['Resupply mission interference', 'Boardings and water cannon', 'Provisional resupply arrangement holding'],
    history: {
      lastMajorEvent: 'CCG boards Philippine resupply boats',
      lastMajorEventDate: '2024-06-17',
      precedentCount: 2,
      precedentDescription: 'Sierra Madre grounded 1999, water cannon 2023',
      cyclicalRisk: 'Each rotation and resupply mission',
    },
    whyItMatters: 'Most likely point for a lethal clash that triggers the US-Philippines treaty',
  },
  {
    id: 'sabina_shoal',
    name: 'Sabina Shoal',
    subtext: 'Escoda Shoal',
    lat: 9.75,
    lon: 116.48,
    location: 'Spratly Islands',
    keywords: ['sabina shoal', 'escoda', 'xianbin'],
    agencies: ['China Coast Guard', 'Philippine Coast Guard'],
    description: 'Staging point for Second Thomas resupply. Site of CCG ramming incidents.',
    status: 'Monitoring',
    escalationScore: 3,
    escalationTrend: 'stable',
    escalationIndicators: ['CCG ramming of PCG cutters', 'Suspected reclamation activity'],
    history: {
      lastMajorEvent: 'CCG rams BRP Teresa Magbanua',
      lastMajorEventDate: '2024-08-31',
    },
    whyItMatters: 'Closest Spratly feature to Palawan',
  },
  {
    id: 'spratly_islands',
    name: 'Spratly Islands',
    subtext: 'Kalayaan Island Group',
    lat: 10.0,
    lon: 114.6,
    location: 'South China Sea',
    keywords: ['spratly', 'kalayaan island', 'nansha', 'whitsun reef', 'julian felipe reef', 'mischief reef', 'panganiban reef', 'fiery cross', 'subi reef'],
    agencies: ['PLA Navy', 'China Coast Guard', 'PAFMM'],
    description: 'Chinese artificial-island bases and militia anchorages among rival outposts.',
    status: 'Monitoring',
    escalationScore: 3,
    escalationTrend: 'stable',
    escalationIndicators: ['Militia swarms at reefs', 'Island-base militarization', 'Reclamation'],
    history: {
      lastMajorEvent: 'About 220 militia vessels mass at Whitsun Reef',
      lastMajorEventDate: '2021-03-07',
    },
    whyItMatters: 'Chinese bases at Mischief, Subi and Fiery Cross project air and naval power across the sea',
  },
  {
    id: 'pagasa_island',
    name: 'Pag-asa Island',
    ...
    lon: 114.28,
    location: 'Spratly Islands',
    keywords: ['pag-asa island', 'thitu', 'zhongye'],
    agencies: ['Armed Forces of the Philippines', 'PAFMM'],
    description: 'Largest Philippine-held Spratly feature. Chinese militia shadow it from Subi Reef.',
    status: 'Monitoring',
    escalationScore: 3,
    escalationTrend: 'stable',
    escalationIndicators: ['Militia vessels near Pag-asa', 'Harassment of Filipino fishers'],
    whyItMatters: 'Civilian Philippine municipality; airstrip within sight of Subi Reef base',
  },
  {
    id: 'reed_bank',
    name: 'Reed Bank',
    ...
    lon: 116.85,
    location: 'South China Sea',
    keywords: ['reed bank', 'recto bank'],
    agencies: ['China Coast Guard', 'Philippine Department of Energy'],
    description: 'Gas-bearing bank inside the Philippine EEZ. Survey-ship harassment.',
    status: 'Monitoring',
    escalationScore: 2,
    escalationTrend: 'stable',
    escalationIndicators: ['Survey vessel harassment', 'Energy exploration disputes'],
    history: {
      lastMajorEvent: 'Chinese vessel sinks Filipino boat Gem-Ver',
      lastMajorEventDate: '2019-06-09',
    },
    whyItMatters: 'Replacement gas for the depleting Malampaya field',
  },
  {
    id: 'paracel_islands',
    name: 'Paracel Islands',
    subtext: 'Xisha / Hoang Sa',
    lat: 16.5,
    lon: 112.0,
    location: 'South China Sea',
    keywords: ['paracel', 'xisha', 'hoang sa', 'woody island'],
    agencies: ['PLA Navy', 'China Coast Guard', 'Vietnam People\'s Navy'],
    description: 'China-held archipelago claimed by Vietnam. Sansha city administration and air base.',
    status: 'Monitoring',
    escalationScore: 3,
    escalationTrend: 'stable',
    escalationIndicators: ['Detention of Vietnamese fishers', 'PLA exercises', 'Woody Island deployments'],
    history: {
      lastMajorEvent: 'HYSY-981 oil rig standoff',
      lastMajorEventDate: '2014-05-02',
      precedentCount: 2,
      precedentDescription: 'Battle of the Paracels 1974, oil rig standoff 2014',
    },
    whyItMatters: 'Anchors Chinese administration of the whole sea from Sansha',
  },
];
