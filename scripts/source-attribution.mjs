...
const PROVIDER_OVERRIDES = {
  ...
  'amti.csis.org': publisherMetadataFeed('AMTI (CSIS)'),
  'www.navalnews.com': publisherMetadataFeed('Naval News'),
...
export const PROVIDER_IDENTITY_REVIEW = Object.freeze({
  sha256: '4a2587750495f187bbb3993077e33cc9f93c444a759e8b309b82088aa918e41e',
  reason: 'Preserve reviewed provider identities, register the two official NASA FIRMS Area API hosts as one provider identity, name TradingView as the provider behind the S&P 500 breadth screener scan that replaced the WAF-blocked Barchart quote pages, exclude the Sentry error-tracking host that the resolve-pin audit reads, group the JODI publication catalog with its existing data host, register GMA News (data.gmanetwork.com, native RSS) and ABS-CBN News (news.abs-cbn.com, via Google News) as Philippine headline-ingest feed publishers, and register AMTI/CSIS (amti.csis.org) and Naval News (www.navalnews.com) as the South China Sea maritime-security feed publishers.',
