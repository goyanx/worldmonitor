...
import { UI_CONTROL_TOOLS } from './ui-control-tools';
...
// UI_CONTROL_TOOLS is appended LAST for the same positional reason the comment
// above gives: every existing tool keeps its index in `tools/list`.
