    ...
    setTrustedHtml(this.ctx.container, trustedHtml(`
      ...
      <div class="header" role="banner">
        ...
        return `
          ...
          <span class="logo">MONITOR</span><span class="logo-mobile">World Monitor</span><span class="version">v${__APP_VERSION__}${isAuthDisabled() ? '-selfhost' : ''}</span>${BETA_MODE ? '<span class="beta-badge">BETA</span>' : ''}
