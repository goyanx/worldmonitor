...
- 761 active data providers across 775 observed source hosts (342 structured/API, 465 news & OSINT feed, 30 operational-status; a host can be more than one), grouped into 10 signal domains — full catalog at https://www.worldmonitor.app/sources/
- 734 feed definitions in the shared feed registry — distinct from the 465 feed-publishing hosts above, since one host can back several feed definitions
